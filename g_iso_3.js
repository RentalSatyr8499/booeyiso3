...
booeyImages[0].src = './art/ghost1.png';
booeyImages[1].src = './art/ghost2.png';
booeyImages[2].src = './art/ghost3.png';
booeyImages[3].src = './art/ghost4.png';

// BG
var bg = new Image()
bg.src = './art/iso1-bg.png';
...
function draw() {
    ...
    ctx.drawImage(bg, 0, canvas.height/4, canvas.width, (bg.height/bg.width)*canvas.width); //bg
